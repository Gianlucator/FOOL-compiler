...
public interface FOOLListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code classDefinitionExp}
	 * labeled alternative in {@link FOOLParser#prog}.
	 * @param ctx the parse tree
	 */
	void enterClassDefinitionExp(FOOLParser.ClassDefinitionExpContext ctx);
	/**
	 * Exit a parse tree produced by the {@code classDefinitionExp}
	 * labeled alternative in {@link FOOLParser#prog}.
	 * @param ctx the parse tree
	 */
	void exitClassDefinitionExp(FOOLParser.ClassDefinitionExpContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link FOOLParser#classfield}.
	 * @param ctx the parse tree
	 */
	void enterClassfield(FOOLParser.ClassfieldContext ctx);
	/**
	 * Exit a parse tree produced by {@link FOOLParser#classfield}.
	 * @param ctx the parse tree
	 */
	void exitClassfield(FOOLParser.ClassfieldContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link FOOLParser#classasm}.
	 * @param ctx the parse tree
	 */
	void enterClassasm(FOOLParser.ClassasmContext ctx);
	/**
	 * Exit a parse tree produced by {@link FOOLParser#classasm}.
	 * @param ctx the parse tree
	 */
	void exitClassasm(FOOLParser.ClassasmContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterClassAssignment(FOOLParser.ClassAssignmentContext ctx);
	/**
	 * Exit a parse tree produced by the {@code classAssignment}
	 * labeled alternative in {@link FOOLParser#dec}.
	 * @param ctx the parse tree
	 */
	void exitClassAssignment(FOOLParser.ClassAssignmentContext ctx);
	/**
